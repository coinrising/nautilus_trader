...
GATE: Final[str] = "GATE"
GATE_VENUE: Final[Venue] = Venue(GATE)

GATE_ALL_PRODUCTS: Final[list[GateProductType]] = [
    GateProductType.SPOT,
]

# Set of Gate error codes for which Nautilus will attempt retries,
...
GATE_SPOT_DEPTHS: Final[tuple[int, ...]] = (1, 50, 200)
